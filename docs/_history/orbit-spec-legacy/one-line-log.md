...
## Governance metadata
- state: superseded
- supersedes: `docs/_history/orbit-spec-legacy/planning-orbit-activity-log-2026-03-29.md`
- superseded_by: `docs/00-current-state.md`
- supersession_reason: activity-log behavior folded into consolidated legacy current-state baseline.
