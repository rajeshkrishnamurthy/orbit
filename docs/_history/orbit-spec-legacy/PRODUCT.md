...
**Status:** Historical baseline (superseded by consolidated current-state baseline)  
**Last updated:** 2026-03-17

## Governance metadata
- state: superseded
- superseded_by: `docs/00-current-state.md`
- supersession_reason: legacy doc claimed canonical truth within archive; consolidated baseline now governs legacy-current interpretation.
