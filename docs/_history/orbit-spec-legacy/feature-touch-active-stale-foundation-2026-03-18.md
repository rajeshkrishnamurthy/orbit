...
- state: superseded
- supersedes:
  - `docs/_history/orbit-spec-legacy/planning-touched-2026-03-18.md`
  - `docs/_history/orbit-spec-legacy/sequence-touch-2026-03-18.md`
...
- supersession_reason: foundational semantics now represented in consolidated current-state baseline after patch folding.
