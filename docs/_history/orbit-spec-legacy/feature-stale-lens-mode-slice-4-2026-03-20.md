...
- state: superseded
- supersedes:
  - `docs/_history/orbit-spec-legacy/feature-touch-active-stale-foundation-2026-03-18.md` (lens deferred scope)
  - `docs/_history/orbit-spec-legacy/feature-stale-normal-view-emphasis-patch-2026-03-18.md` (lens relation)
- superseded_by: `docs/00-current-state.md`
- supersession_reason: lens behavior now folded into consolidated baseline.
