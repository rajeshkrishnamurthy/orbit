...
## Governance metadata
- state: superseded
- supersedes: `docs/_history/orbit-spec-legacy/feature-touch-active-stale-foundation-2026-03-18.md` (normal-view stale visibility scope)
- superseded_by: `docs/00-current-state.md`
- supersession_reason: stale emphasis behavior folded into consolidated baseline.
