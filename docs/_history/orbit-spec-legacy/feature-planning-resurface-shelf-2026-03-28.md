...
## Governance metadata
- state: superseded
- supersedes: `docs/_history/orbit-spec-legacy/planning-resurface-shelf-handoff-2026-03-28.md`
- superseded_by: `docs/00-current-state.md`
- supersession_reason: consolidated baseline preserves snooze/resurface semantics but normalizes presentation as hidden-tray cards with badge-state changes.
