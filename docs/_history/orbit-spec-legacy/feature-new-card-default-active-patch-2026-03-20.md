...
## Governance metadata
- state: superseded
- supersedes: `docs/_history/orbit-spec-legacy/feature-touch-active-stale-foundation-2026-03-18.md` (new-card derivation gap)
- superseded_by: `docs/00-current-state.md`
- supersession_reason: amended activity-anchor rule folded into consolidated baseline.
