...
## Governance metadata
- state: superseded
- supersedes: `docs/_history/orbit-spec-legacy/feature-last-mile-completion-flow-2026-03-16.md`
- superseded_by:
  - `docs/_history/orbit-spec-legacy/feature-in-card-hover-action-drawer-2026-03-17.md`
  - `docs/00-current-state.md`
- supersession_reason: card action model later consolidated around top-right hover drawer and baseline summary.
